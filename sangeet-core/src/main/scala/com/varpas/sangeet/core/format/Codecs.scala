...
/** Facade re-exporting all codecs for backward compatibility. Use `import Codecs.given` to get all encoder/decoder
  * instances. Implementation is split into ModelCodecs, OrnamentCodecs, and CompositionCodecs.
  */
object Codecs:
