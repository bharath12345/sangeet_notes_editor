...
class LineBreakerMultiTaalSpec extends AnyFlatSpec with Matchers:
  ...
  "LineBreaker with Rupak (7 matras)" should "produce one line for full cycle" in {
    val lines = breakLine(TestTaals.all("rupak"), eventsForBeats(7))
