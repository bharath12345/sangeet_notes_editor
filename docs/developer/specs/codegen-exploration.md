# Codegen Exploration (archived)

> **Archived 2026-06-15.** This document explored 5 ranked spec/codegen items. Items 1–3 (OpenAPI export, `.swar` JSON Schema, specs README) shipped in **PR-1c** of Plan 18 — see [plan-18-hygiene-obs-codegen.md](../plans/plan-18-hygiene-obs-codegen.md). Items 4 (toolbar codegen) and 5 (full domain model codegen) are deferred; revisit if dashboards / cross-platform parity motivates them.
>
> Original PR: [#79](https://github.com/bharath12345/sangeet_notes_editor/pull/79).
